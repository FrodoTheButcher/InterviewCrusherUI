...
import { Input, InputAdornment, InputLabel, TextField, Tooltip } from '@mui/material'
    ...
    <>
     ...
     : data && !loading && !error ? <CustomizedSnackbars severity={"success"} isOpen={true}  message={data}/> : null
      ...
      <Row >
        ...
        <SendEmailPopup title={"Contact us!"} message={"If you want to add your own course and collaborate with us , contact us!"}  />
        <EmailPopup />
        </Col>
          ...
          <Row style={{ borderTop: '1px  solid rgba(255, 255, 255, 0.5)' ,padding:'20px'}}>
              ...
              <Col style={{color:'white'}} className='d-flex align-items-center justify-content-center'>
                 <Col className='FooterSocial'>
                     <Tooltip title="whatsapp: 0775664290">
                  ...
                  <Col className='FooterSocial'>
                     <Tooltip title="facebook: robi.fodor.9">
                     <a href='https://www.facebook.com/robi.fodor.9'  style={{color:'white',background:'transparent',outline:'none'}}>
                  ...
                  <Col className='FooterSocial'>
                   <Tooltip title="youtube: MyAcodemy">
                    <a href='https://www.youtube.com/channel/UCvbqDspHojUluULnU0BPdyA' style={{color:'white',background:'transparent',outline:'none'}}>
                  ...
                  <Col className='FooterSocial'>
                      <Tooltip title="instagram: r.fodor.9">
                        <a href='https://www.instagram.com/robi.fodor.9/' style={{color:'white',background:'transparent',outline:'none'}}>
